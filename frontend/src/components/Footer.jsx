...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 text-gray-300 bg-[#632dc0]">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <h1 className="text-2xl font-bold">
            ...
            <p>Created by Siddharth <span className='text-white'><FontAwesomeIcon icon={faHeart} /></span></p>
          </div>
